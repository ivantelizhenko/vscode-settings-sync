...
export function isGameOver(): string | null {
  ...
  const checks: [() => boolean, string][] = [
    ...
    [() => chess.isDrawByFiftyMoves(), 'Draw due to 50 step rule'],
    [() => chess.isThreefoldRepetition(), 'Draw due to triple repetition'],
    [() => chess.isInsufficientMaterial(), 'Draw due to lack of material'],
    [() => chess.isDraw(), 'Draw'],
  ];
