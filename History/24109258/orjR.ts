...
export function isGameOver(): string | null {
  ...
  const checks: [() => boolean, string][] = [
    [() => chess.isCheckmate(), 'Checkmate', type: 'win'],
    [() => chess.isStalemate(), 'Stalemate', type: 'draw'],
    [() => chess.isDrawByFiftyMoves(), 'Draw due to 50 step rule', type: 'draw'],
    [() => chess.isThreefoldRepetition(), 'Draw due to triple repetition', type: 'draw'],
    [() => chess.isInsufficientMaterial(), 'Draw due to lack of material', type: 'draw'],
