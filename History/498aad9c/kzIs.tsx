const card =
  'card__side card__side--front absolute top-0 left-0 h-52 w-full overflow-hidden text-3xl font-semibold backface-hidden perspective-dramatic';
('card__side card__side--back absolute top-0 left-0 h-52 w-full overflow-hidden text-3xl font-semibold backface-hidden perspective-dramatic');
function Card() {
  return (
