...
function Users() {
  ...
  return (
    <StyledUsers>
      <span id="styledUsers-heading">
        <Heading as="h2">Users</Heading>
      </span>
      <span id="styledUsers-message">
