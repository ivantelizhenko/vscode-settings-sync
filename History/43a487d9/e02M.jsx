...
function Highlight({ text, as }) {
  ...
  const firstPart = text.slice(0, firstIndex + 1);
  const higlightingText = text.slice(firstIndex, lastIndex + 1);
  const lastPart = text.slice(lastIndex, text.length - lastIndex);
