...
// But we can create an object based on this class only once, because anothers are the same.(Check from console.log())
const x = Example.getInstance();
const x1 = Example.getInstance();
const x2 = Example.getInstance();
