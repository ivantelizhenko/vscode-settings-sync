...
console.log(
  `${myCountry.country} has ${myCountry.population} ukrainian-speaking, ${myCountry.neighbours.length} neighbouring countries and a capital called ${myCountry.capital}. `
);
