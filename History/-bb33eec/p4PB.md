...
- Зробити доступний тільки фільтр з departments, а коли буде обрано більше трьох департаментів, то зробити активними інші **(ще не зроблено)**
- При натисканні на кнопку зі смітничком повертати всі фільтри до дефолтного значення **(ще не зроблено)**
- Забирати фільтри з посилання і фільтрувати масив users за фільтрами **(ще не зроблено)**
