...
- Встановлювати фільтри у посилання (ще не зроблено)
- Зробити доступний тільки фільтр з departments, а коли буде обрано більше трьох департаментів, то зробити активними інші _(ще не зроблено)_
- При натисканні на кнопку зі смітничком повертати всі фільтри до дефолтного значення
- Забирати фільтри з посилання і фільтрувати масив users за фільтрами

Додатково:

- Створюю окремий ContextAPI для фільтрів та для модал віндов
