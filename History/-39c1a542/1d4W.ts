import { DataObjectType, DataType, VievCore } from "../types/interfaces";

const icons = require("../../img/icons.svg") as string;

export default abstract class View implements VievCore {
  data?: unknown;

  abstract parentElement: HTMLElement;
  abstract generateMarkup(): void;
