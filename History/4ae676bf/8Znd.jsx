...
function LetterCapitalize(phrase) {
  ...
  const phraseAllFirstLettersCapitalize = phraseArray
    .map((word) => {
      const [firstLetter, ...restLetters] = word.split("");
      return firstLetter.toUpperCase() + restLetters.join("").toLowerCase();
    })
    .join(" ");
  console.log(phraseAllFirstLettersCapitalize);
  return phraseAllFirstLettersCapitalize;
}
[];

LetterCapitalize("i want test last word");
LetterCapitalize("AaA aAaAaA aAaaaA aaaaa AAAAaaa aaaaAAAA");
