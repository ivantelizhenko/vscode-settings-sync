...
// We can use optional Parameters & Properties(:)
class Persone {
  name?: string | undefined;

  constructor(n?: string | undefined, public surname?: string | undefined) {
    this.name = n;
  }
...
const me = new Persone("", "Telizhenko");
const friend = new Persone("Mark");

me.printName(); // You don't have a name
me.setName("Ivan");
me.printName(); // Ivan Telizhenko
