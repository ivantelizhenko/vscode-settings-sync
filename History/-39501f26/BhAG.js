...
function Page({ number, name, videos, numberSection, onSwitch, show, onShow }) {
  ...
  return (
    <div className="list">
      ...
      <List videos={videos} numberSection={numberSection} onSwitch={onSwitch} />
    </div>
  );
}
...
function ListTitle({ name, number, videos, setShow }) {
  ...
  return (
    <div className="list__title">
      ...
      <button onClick={setShow} className="list__button">
        &darr;
      </button>
    </div>
  );
