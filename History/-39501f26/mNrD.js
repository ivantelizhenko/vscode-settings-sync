...
function App() {
  ...
  function handleSwitch(sectionId, videoId, check) {
    setSections(canSwitch(sectionId, videoId, check));
  }
...
function List({ number, name, videos, numberSection, onSwitch }) {
  return (
    <div className="list">
  ...
  return (
    <li className="list__item">
      <input
        ...
        onClick={() => onSwitch(numberSection, numberVideo, newChecked)}
      />
      <div>
