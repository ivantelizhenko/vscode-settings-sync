...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    secondarySmall:
      'inline-block rounded-full border-2 border-stone-300 text-xs font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-300 hover:text-stone-800 focus:bg-stone-300 focus:text-stone-800 focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2 disabled:cursor-not-allowed sm:px-10 sm:py-0.5',
  };
