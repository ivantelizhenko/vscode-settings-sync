  ...
  switch (action.type) {
    ...
    case 'search/filterNotes':
      return {
        ...state,
        filteredNotes: [
          ...state.notes.filter(note => note.title.includes(state.searchValue)),
        ],
      };
...
function NotesProvider({ children }) {
  const [
    { notes, searchValue, selectedNoteId, isOpenModal, isLoading },
    dispatch,
  ...
  useEffect(() => {function filterNotes() {
    dispatch({ type: 'search/filterNotes' });}, [searchValue])
