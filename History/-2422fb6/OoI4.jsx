import { HiMiniPlus, HiOutlinePlus, HiOutlineTrash } from 'react-icons/hi2';
  ...
  return (
    <div className={styles.header}>
      ...
      <div className={styles.button__container}>
        ...
        <div className={(styles.button__add, styles.button)}>Button Add</div>
        <div className={(styles.button__remove, styles.button)}>
          Button Delete
        </div>
      </div>
