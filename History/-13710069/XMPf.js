...
export default function onesMinusZeros(arr) {
  ...
  const diff11 = onesRows[0] + onesColumns[0] - zerosRows[0] - zerosColumns[0];
  const diff12 = onesRows[0] + onesColumns[0] - zerosRows[0] - zerosColumns[0];
  const diff20 = onesRows[0] + onesColumns[0] - zerosRows[0] - zerosColumns[0];
  const diff21 = onesRows[0] + onesColumns[0] - zerosRows[0] - zerosColumns[0];
  const diff22 = onesRows[0] + onesColumns[0] - zerosRows[0] - zerosColumns[0];
}
