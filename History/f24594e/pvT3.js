...
if (sarahDog.curFood > sarahDog.recommendedFood * 1.1)
  console.log('Sarah, your dog eats too much');
else if (sarahDog.curFood < sarahDog.recommendedFood * 0.9)
  console.log('Sarah, your dog eats not enought');
else console.log('Sarah, your dog eat well');

// 3.
const ownersEatTooMuch = [];
const ownersEatTooLittle = [];
dogs.map(map => {
  if (map.curFood > map.recommendedFood * 1.1)
    ownersEatTooMuch.push(...map.owners);
  else if (map.curFood < map.recommendedFood * 0.9)
    ownersEatTooLittle.push(...map.owners);
});
...
//5
console.log(
  map.curFood < map.recommendedFood * 1.1 &&
    map.curFood > map.recommendedFood * 0.9
);
///////////////////////////////////
const books = [
  {
