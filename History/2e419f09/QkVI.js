...
const linksBar = document.querySelector('.nav__links ');
const btnOpenBar = document.querySelector('.btn__open--bar ');
const btnCloseBar = document.querySelector('.btn__close--bar ');
...
const hideBar = () => {
  ...
  btnOpenBar.style.display = 'block';
  btnCloseBar.style.display = 'none';
  logo.style.opacity = 100;
};

const showBar = () => {
  btnOpenBar.style.display = 'none';
  btnCloseBar.style.display = 'block';
...
btnOpenBar.addEventListener('click', showBar);
btnCloseBar.addEventListener('click', hideBar);
document.querySelector('body').addEventListener('click', hideBar);
// showBar();
// hideBar();
