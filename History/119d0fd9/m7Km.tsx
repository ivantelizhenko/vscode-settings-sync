...
import useSetGameOver from '../hooks/useSetGameOver';
...
function GameOverWindow() {
  ...
  }, [deleteGame, dispatch, gameId, navigate]);
  ...
  }, [isGameOver, handleGameEnd, setGameOver]);

  return (
    <Wrapper>
      <p>{type === 'win' ? messageWin : messageDraw}</p>

      <Button onClick={handleGameEnd}>Back to the main menu</Button>
    </Wrapper>
  );
}
