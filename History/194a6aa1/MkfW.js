...
(function () {
  //Expression
  console.log('this function will really never be called(trust me!)');
})();
// We cannot to call this(↑) again

(() => console.log('heeey!'))(); //Arrow
// And we cannot to call this(↑) again too
*/
...
document.header.addEventListener('click', function () {
  // console.log('heeey');
