...
class App {
  ...
  constructor() {
    ...
    containerWorkouts.addEventListener('click', this._movetToPopup.bind(this));
  }
  ...
  _newWorkout(e) {
    ...
    // if workout cycling, creat e cycling object
    if (type === 'cycling') {
...
const app = new App();
// btnDeleteAll.addEventListener('click', app.reset());
...
const filteredWorks = works.filter(work => work.id === e.target.id);
