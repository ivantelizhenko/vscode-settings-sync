...
import { addIDs, addLocalStorageIDs } from '../../store/statusSlice';
...
function Menu() {
  ...
  const { gameId, localStorageIDs } = useAppSelector(state => state.status);
  ...
  useEffect(() => {
    ...
    dispatch(addLocalStorageIDs(localStorageIDs));
  ...
  }, [dispatch, localStorageIDs.gameId, localStorageIDs?.userId]);
